...
from qtvcp.widgets.touch_file_manager import TouchFileManager
...
# TouchFileManager
####################################
class TouchFileManagerPlugin(QPyDesignerCustomWidgetPlugin):
    def __init__(self, parent=None):
        super(TouchFileManagerPlugin, self).__init__(parent)
        self.initialized = False
    ...
    def createWidget(self, parent):
        return TouchFileManager(parent)

    def name(self):
        return "TouchFileManager"

    def group(self):
        return "Linuxcnc - Controller"

    def icon(self):
        return QtGui.QIcon(QtGui.QPixmap(ICON.get_path('touchfilemanager')))
    ...
    def domXml(self):
        return '<widget class="TouchFileManager" name="touchfilemanager" />\n'

    def includeFile(self):
        return "qtvcp.widgets.touch_file_manager"
